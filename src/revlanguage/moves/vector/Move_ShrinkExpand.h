#ifndef Move_ShrinkExpand_H
#define Move_ShrinkExpand_H
...
class TypeSpec;
     ...
     */
    class Move_ShrinkExpand : public Move {
        
    public:
        
        Move_ShrinkExpand(void);                                                                                                                    //!< Default constructor
        
        // Basic utility functions
        virtual Move_ShrinkExpand*                  clone(void) const;                                                                              //!< Clone the object
