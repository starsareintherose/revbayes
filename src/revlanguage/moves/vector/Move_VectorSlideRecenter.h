#ifndef Move_VectorSlideRecenter_H
#define Move_VectorSlideRecenter_H
...
class TypeSpec;
     ...
     */
    class Move_VectorSlideRecenter : public Move {
        
    public:
        
        Move_VectorSlideRecenter(void);                                                                                                                    //!< Default constructor
        
        // Basic utility functions
        virtual Move_VectorSlideRecenter*           clone(void) const;                                                                              //!< Clone the object
    ...
    protected:
        ...
        RevPtr<const RevVariable>                   mean;                                                                                              //!< The variable holding the real valued vector.
