#ifndef Move_ScaleBactrian_H
#define Move_ScaleBactrian_H
...
class TypeSpec;
     ...
     *
     */
    class Move_ScaleBactrian : public Move {
        
    public:
        
        Move_ScaleBactrian(void);                                                                                                                       //!< Default constructor
        
        // Basic utility functions
        virtual Move_ScaleBactrian*                         clone(void) const;                                                                          //!< Clone object
