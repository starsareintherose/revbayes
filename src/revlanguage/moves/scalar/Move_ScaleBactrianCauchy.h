#ifndef Move_ScaleBactrianCauchy_H
#define Move_ScaleBactrianCauchy_H
...
class TypeSpec;
     ...
     *
     */
    class Move_ScaleBactrianCauchy : public Move {
        
    public:
        
        Move_ScaleBactrianCauchy(void);                                                                                                                       //!< Default constructor
        
        // Basic utility functions
        virtual Move_ScaleBactrianCauchy*           clone(void) const;                                                                          //!< Clone object
