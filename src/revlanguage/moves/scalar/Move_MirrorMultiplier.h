 ...
 *
 * @brief Declaration of Move_MirrorMultiplier
 *
 * (c) Copyright 2009-
...
#ifndef Move_MirrorMultiplier_H
#define Move_MirrorMultiplier_H
...
class TypeSpec;
    ...
    class Move_MirrorMultiplier : public Move {

    public:

        Move_MirrorMultiplier(void);                                                                                                                   //!< Default constructor (0.0)

        // Basic utility functions
        virtual Move_MirrorMultiplier*                         clone(void) const;                                                                      //!< Clone object
