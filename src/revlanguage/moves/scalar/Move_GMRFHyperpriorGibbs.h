...
class TypeSpec;
     ...
     */
    class Move_GMRFHyperpriorGibbs : public Move {

    public:

        Move_GMRFHyperpriorGibbs(void);                                                                                                         //!< Default constructor

        // Basic utility functions
        virtual Move_GMRFHyperpriorGibbs*                  clone(void) const;                                                                              //!< Clone the object
