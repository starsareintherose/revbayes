#ifndef Move_RootTimeSlideRateScaleProposal_H
#define Move_RootTimeSlideRateScaleProposal_H
...
namespace RevLanguage {
     ...
     * See the AVMVNMove.h for more details.
     *
     *
     ...
     *
     */
    class Move_RootTimeSlideRateScaleProposal : public Move {
        
    public:
        
    	Move_RootTimeSlideRateScaleProposal(void);                                                                                                             //!< Default constructor
        
        // Basic utility functions
        virtual Move_RootTimeSlideRateScaleProposal* clone(void) const;                                                                          //!< Clone object
    ...
    protected:
        ...
        RevPtr<const RevVariable>                   alpha;                                                                                         //!< The variable for the tuning parameter.
