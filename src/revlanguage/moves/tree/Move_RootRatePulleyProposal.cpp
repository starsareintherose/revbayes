 ...
 */
Move_RootRatePulleyProposal::Move_RootRatePulleyProposal() : Move()
{
...
RevPtr<RevVariable> Move_RootRatePulleyProposal::executeMethod(const std::string& name, const std::vector<Argument>& args, bool &found)
{
    ...
    if ( name == "addRates" )
    {
        ...
        RevBayesCore::RootRatePulleyProposal &prop = static_cast<RevBayesCore::RootRatePulleyProposal&>( m->getProposal() );
 ...
 */
Move_RootRatePulleyProposal* Move_RootRatePulleyProposal::clone(void) const
{
    
    return new Move_RootRatePulleyProposal(*this);
}
 ...
 */
void Move_RootRatePulleyProposal::constructInternalObject( void )
{
    ...
    RevBayesCore::RootRatePulleyProposal *prop = new RevBayesCore::RootRatePulleyProposal(n, r);
 ...
 */
const std::string& Move_RootRatePulleyProposal::getClassType(void)
{
    
    static std::string rev_type = "Move_RootRatePulleyProposal";
 ...
 */
const TypeSpec& Move_RootRatePulleyProposal::getClassTypeSpec(void)
{
 ...
 */
std::string Move_RootRatePulleyProposal::getHelpDescription(void) const
{
 ...
 */
std::string Move_RootRatePulleyProposal::getMoveName( void ) const
{
    // create a constructor function name variable that is the same for all instance of this class
    std::string c_name = "RootRatePulleyProposal";
 ...
 */
const MemberRules& Move_RootRatePulleyProposal::getParameterRules(void) const
{
 ...
 */
const TypeSpec& Move_RootRatePulleyProposal::getTypeSpec( void ) const
{
...
void Move_RootRatePulleyProposal::printValue(std::ostream &o) const
{
    
    o << "Move_RootRatePulleyProposal(?)";
    if (tree != NULL)
    {
        o << tree->getName();
    }
 ...
 */
void Move_RootRatePulleyProposal::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
