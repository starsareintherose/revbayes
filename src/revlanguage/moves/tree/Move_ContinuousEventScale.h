#ifndef Move_ContinuousEventScale_H
#define Move_ContinuousEventScale_H
...
class TypeSpec;
     ...
     */
    class Move_ContinuousEventScale : public Move {
        
    public:
        
        Move_ContinuousEventScale(void);                                                                                                                    //!< Default constructor
        
        // Basic utility functions
        virtual Move_ContinuousEventScale*                  clone(void) const;                                                                      //!< Clone object
