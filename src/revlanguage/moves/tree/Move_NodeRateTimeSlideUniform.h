...
class TypeSpec;
     ...
     */
    class Move_NodeRateTimeSlideUniform : public Move {
        
    public:
        
        Move_NodeRateTimeSlideUniform(void);                                                                                                    //!< Default constructor
        
        // Basic utility functions
        virtual Move_NodeRateTimeSlideUniform*             clone(void) const;                                                                      //!< Clone object
