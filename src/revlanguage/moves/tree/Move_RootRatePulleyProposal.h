#ifndef Move_RootRatePulleyProposal_H
#define Move_RootRatePulleyProposal_H
...
namespace RevLanguage {
     ...
     *
     */
    class Move_RootRatePulleyProposal : public Move {
        
    public:
        
    	Move_RootRatePulleyProposal(void);                                                                                                             //!< Default constructor
        
        // Basic utility functions
        virtual Move_RootRatePulleyProposal*         clone(void) const;                                                                          //!< Clone object
