#ifndef Move_RateAgeProposal_H
#define Move_RateAgeProposal_H
...
class TypeSpec;
     ...
     *
     */
    class Move_RateAgeProposal : public Move {
        
    public:
        
        Move_RateAgeProposal(void);                                                                                                             //!< Default constructor
        
        // Basic utility functions
        virtual Move_RateAgeProposal*               clone(void) const;                                                                          //!< Clone object
