...
class TypeSpec;
     ...
     * See the Move_MultiValueEventSlide.h for more details.
     *
     *
     ...
     *
     */
    class Move_MultiValueEventSlide : public Move {
        
    public:
        
        Move_MultiValueEventSlide(void);                                                                                                         //!< Default constructor
        
        // Basic utility functions
        virtual Move_MultiValueEventSlide*              clone(void) const;                                                                          //!< Clone object
