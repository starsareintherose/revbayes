#ifndef Move_HomeologPhase_H
#define Move_HomeologPhase_H
...
class TypeSpec;
     ...
     *
     */
    class Move_HomeologPhase : public Move {
        
    public:
        
        Move_HomeologPhase(void);                                                                                                            //!< Default constructor
        
        // Basic utility functions
        virtual Move_HomeologPhase*                 clone(void) const;                                                                          //!< Clone object
