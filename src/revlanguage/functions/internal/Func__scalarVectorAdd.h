...
{
    static std::string rev_type = "Func__scalarVectorAdd<" + firstValType::getClassType() + "," + secondValType::getClassType() + "," + retType::getClassType() + ">";
...
const RevLanguage::TypeSpec& RevLanguage::Func__scalarVectorAdd<firstValType, secondValType, retType>::getClassTypeSpec(void)
{
    ...
    static TypeSpec rev_type_spec = TypeSpec( Func__scalarVectorAdd<firstValType, secondValType, retType>::getClassType(), new TypeSpec( Function::getClassTypeSpec() ) );
