...
class TypeSpec;
     ...
     *
     */
    class Dist_pointMassPositive : public PositiveContinuousDistribution {

    public:
        Dist_pointMassPositive ( void );
        virtual ~Dist_pointMassPositive();

        // Basic utility functions
        Dist_pointMassPositive*                                 clone(void) const;                                                                      //!< Clone the object
