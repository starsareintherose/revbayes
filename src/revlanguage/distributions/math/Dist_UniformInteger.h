#ifndef Dist_UniformInteger_H
#define Dist_UniformInteger_H
...
class TypeSpec;
     ...
     * in a model graph.
     * See the UniformIntegerDistribution for more details.
     *
     *
     ...
     *
     */
    class Dist_UniformInteger : public TypedDistribution<Integer> {
        
    public:
        Dist_UniformInteger( void );
        virtual ~Dist_UniformInteger();
        
        // Basic utility functions
        Dist_UniformInteger*                            clone(void) const;                                                                      //!< Clone the object
