...
namespace RevBayesCore {
     ...
     *
     */
    class RootTimeSlideRateScaleProposal : public Proposal {
        
    public:
    	RootTimeSlideRateScaleProposal(StochasticNode<Tree> *n, StochasticNode<double> *o, double a, double p=0.44);                                 //!< Constructor
        
        void                                        addRates(std::vector<StochasticNode<double> *> v);                         //!< Add an up-scaling variable
        void                                        addRates(StochasticNode<RbVector<double> > *v);                         //!< Add an up-scaling variable

        void                                        cleanProposal(void);                                                                //!< Clean up proposal
        RootTimeSlideRateScaleProposal*              clone(void) const;                                                                  //!< Clone object
    ...
    private:
        ...
        std::vector<StochasticNode<RbVector<double> > *>     branch_vectors;
        ...
        std::vector< RbVector<double> >                      stored_vectors;
