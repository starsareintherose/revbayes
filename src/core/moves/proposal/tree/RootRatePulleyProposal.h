...
namespace RevBayesCore {
     ...
     *
     */
    class RootRatePulleyProposal : public Proposal {
        
    public:
    	RootRatePulleyProposal(StochasticNode<Tree> *n, double p=0.44);                                 //!< Constructor
        ...
        RootRatePulleyProposal*                     clone(void) const;                                                                  //!< Clone object
